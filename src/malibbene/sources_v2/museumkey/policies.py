"""MuseumKey policies scraper (sources_v2).

Reuses ``extract_policy_text`` from the assabet policies module — same shape
(card_page / pass_page clean text + eligibility classification).
"""
