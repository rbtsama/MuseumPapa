...
## 5. Pass 居住限制 residency_restriction(真正的预订筛选)— 217/1033 仍 unknown
...
**当前(816/1033 已确定):** 241 resident-only / 575 open / 217 unknown。
...
### 5A. 拿不到 — 无法 probe 的来源(217 unknown 的构成)
